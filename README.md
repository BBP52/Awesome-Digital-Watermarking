...
## Papers
 ...
 | A screen-shooting resilient document image watermarking scheme using deep neural network | 南大 | IET IP 2022 | DNN。失真层：模拟屏幕拍摄过程中的失真，使带水印的图像能够对真实屏幕拍摄场景中的失真（相机失真、拍摄失真和光源失真）具有弹性。一种嵌入强度调整策略 | 视觉质量相比提高，而位精度损失较小 | Demerits | [Paper](https://ietresearch.onlinelibrary.wiley.com/doi/epdf/10.1049/ipr2.12653) | [DocImgEN](https://github.com/gslxr/Document-image-watermarking) | |
